<div class="mockup-body grey4" style="margin: 0 auto; color: #000;">
	...
	<section id="mockup-main" role="main" class="grid edit pam grey4">
		<div class="grid2-1">
			<div class="txtchange">Yoo ch'ai lu dans les DNA que le Racing a encore perdu contre Oberschaeffolsheim. du chambon, un kuglopf et du schnaps dans mon rucksack. Allez, s'guelt ! Wotch a kofee avec ton bibalaekaess et ta wurscht ? Yeuh non che suis au réchime je ne mange plus que des Grumbeere light et che fais de la chym avec Chulien. Tiens, un rottznoz sur le comptoir Tu restes pour le lotto-owe ce soir, y'a baeckeoffe ? Yeuh non, merci vielmols mais che dois partir à la Coopé de Truchtersheim acheter des mänele et des rossbolla</div>
			<aside class="txtchange">Verdammi et moi ch'avais donc parié deux knacks et une flammekueche. Ah so ? T'inquiète, ch'ai ramené du schpeck</aside>
		</div>
	</section>
